...
export function Landing() {
  return (
    <PublicLayout>
      ...
      {/* Instant Email Generator Section */}
      <div className="py-16 bg-gradient-to-r from-[#4A90E2]/5 to-[#357ABD]/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="p-8 lg:p-12">
              <div className="text-center mb-8">
                ...
                <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                  Create disposable email addresses instantly with our free temporary email generator. No registration required!
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-600">Generate email in seconds, no sign up needed</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    <h3 className="text-lg font-semibold text-gray-900">48-Hour Validity</h3>
                    <p className="text-gray-600">Perfect for quick verifications and testing</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    <h3 className="text-lg font-semibold text-gray-900">Spam Protected</h3>
                    <p className="text-gray-600">Advanced filters keep your inbox clean</p>
                  </div>
                </div>
              </div>
              ...
              <div className="text-center">
                <Link
                  ...
                  className="inline-flex items-center bg-[#4A90E2] text-white px-8 py-4 rounded-lg font-medium hover:bg-[#357ABD] transition-colors group"
                >
                  Create Instant Email
                  <ArrowRight className="w-5 h-5 ml-2 transform group-hover:translate-x-1 transition-transform" />
                </Link>
                <p className="mt-4 text-sm text-gray-500">
                  No registration • No credit card • 100% free
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-12 prose max-w-none">
            <h2 className="sr-only">Free Temporary Email Generator</h2>
            <div className="sr-only">
              ...
              <ul>
                ...
                <li>48-hour validity</li>
                <li>Spam protection</li>
                <li>Real-time email updates</li>
